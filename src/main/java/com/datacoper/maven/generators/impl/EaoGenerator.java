 ...
 * @author alessandro
 */
public class EaoGenerator extends AbstractGenerator<TClass> {
    
    public EaoGenerator(MavenProject project, TClass data) {
        super(project, "eao", data);
    }
    ...
    protected TClass prepareForGenerate(TClass clazz) {
        return new TClassBuilder(clazz)
                ...
                .withClassName(data.getClassName().concat("EAO"))
                .build();
    }
}
