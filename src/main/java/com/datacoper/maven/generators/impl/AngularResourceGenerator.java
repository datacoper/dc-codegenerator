...
public class AngularResourceGenerator extends AbstractGenerator {

	public AngularResourceGenerator(File projectParentFile, String entityName, Company company, String moduleName) {
