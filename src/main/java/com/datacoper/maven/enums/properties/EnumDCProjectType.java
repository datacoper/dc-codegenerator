...
public enum EnumDCProjectType {
    ...
    REST("RestAPI", WAR, EnumSourceType.JAVA),
    REST_TEST("RestAPI", WAR, EnumSourceType.JAVA_TEST),
    REST_COMMON("RestAPICommon", JAR, EnumSourceType.JAVA),
    REST_COMMON_TEST("RestAPICommon", JAR, EnumSourceType.JAVA_TEST),
